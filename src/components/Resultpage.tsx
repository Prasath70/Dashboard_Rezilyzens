  ...
  return (
    <div className="w-full">
      <div className="flex items-center justify-end gap-3 py-2">
        <div className="bg-[#3a4066] rounded-3xl text-white px-4 py-1 ">
          <div className="h-[1.7rem] w-[1.7rem] rounded-full bg-transparent  bg-[#AC47F7] text-white flex items-center justify-center ">
...
const Customaccordion: React.FC<accordionprops> = ({
  ...
  return (
    <div
      className="flex flex-col  group transition ease-in-out duration-200 cursor-pointer focus-within:bg-[#1a2b67]  bg-white w-full px-3 h-full border-[2px] rounded-lg border-[#AC47F7] border-l-[0.9rem]  py-8 bg-opacity-10 backdrop-filter backdrop-blur-lg duration-300"
      tabIndex={0}
    >
      <div className="flex flex-row items-center justify-between">
        <h1 className="text-white text-md tracking-wide  transition ease-in-out duration-100">
          {heading}
        </h1>
        <div className="flex items-center justify-center gap-4">
          ...
          <div className="h-[1.7rem] w-[1.7rem] rounded-full bg-transparent bg-[#eb886a] text-white flex items-center justify-center">
            <IoMdClose className="mx-auto h-[0.9rem] w-[0.9rem]" />
          </div>
          <div className="h-[1.7rem] w-[1.7rem] rounded-full bg-transparent bg-[#8586be] text-white flex items-center justify-center">
            <MdElectricBolt className="mx-auto h-[0.9rem] w-[0.9rem]" />
          </div>
      ...
      <div className="hidden group-focus:block group-focus:h-full   group-focus:h-10 transition ease-in-out duration-700 px-1 py-3 ">
